...
const CLIP_NOTES = {
  ...
  'slow-blink': '느린 눈인사 · A long, trusting blink and a gentle bow.',
  sleepy: '졸다가 아닌 척 · One ear wakes first; an innocent stare follows.',
  proud: '은근한 뿌듯함 · Soft eyes, chin up, quietly pleased.',
  'feign-ignore': '못 들은 척 · Looking away, with one ear still listening.',
  'ring-side-eye': '링 눈치 보기 · It settles. Look up. It moves again.',
